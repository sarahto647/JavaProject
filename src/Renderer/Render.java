...
public class Render {
	...
	private Map<Geometry,Point3D> getClosestPoint(Map<Geometry,List<Point3D>> intersectionPoints)//this function 
	//return the closest point to the camera (P0) in the intersectionPoints list
	{
